...
def capturar(data_dir: Path, ds_dir: Path, fecha_corte: str):
    ev_dir = ds_dir / "scraping"
...
def verificar(ds_dir: Path, run_id: str):
    ev_dir = ds_dir / "scraping"
    run_dir = ev_dir / run_id
...
if __name__ == "__main__":
    ...
    d = Path(a.data_dir)
    ds = Path(a.ds_dir)
    sys.exit(verificar(ds, a.verificar) if a.verificar else capturar(d, ds, a.fecha_corte))
